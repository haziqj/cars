...
-   ⚠️ **Minor dent** on the **right side body panel** — also due to road debris

-   ⚠️ **Underside scuff** at the **front** — from a tall speed bump (not visible unless under the car)

-   ⚠️ **60 Years side scuttle sticker** has a **slight warp** — cosmetic only, replaceable if desired
